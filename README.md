...
* **Biblioteca de dados:** Pandas (Tratamento de dados)
* **Visualização:** Plotly / Matplotlib (Geração de gráficos)
* **Ambiente de Desenvovimento:** VS Code e Terminal Linux (Debian) / Windows 11

## Estrutura do Repositório
* /automacoes/ : Projetos focados em carregar arquivos (como  .csv), tratar dados nulos e gerar relatório visuais

## Próximos Passos
- [ ] Integração de scripts Python com Planilhas de Excel.
- [ ] Conexão de dados tratados com ferramentas de Dashboard (Power BI).
- [ ] Criação de um projeto completo de análise de ponta a ponta.
